...
//定义MFRC522的引脚操作
#define MF522_NSS(x)        (x) ? GPIO_SetBits(GPIOD,GPIO_Pin_7) :GPIO_ResetBits(GPIOD,GPIO_Pin_7)
#define MF522_SCK(x)        (x) ? GPIO_SetBits(GPIOD,GPIO_Pin_6) :GPIO_ResetBits(GPIOD,GPIO_Pin_6)
#define MF522_MOSI(x)       (x) ? GPIO_SetBits(GPIOC,GPIO_Pin_6) :GPIO_ResetBits(GPIOC,GPIO_Pin_6)
#define MF522_RST(x)        (x) ? GPIO_SetBits(GPIOC,GPIO_Pin_11):GPIO_ResetBits(GPIOC,GPIO_Pin_11)

#define MF522_MISO_READ     GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_8)  
