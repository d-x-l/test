...
void MFRC522_SPI_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin 	= GPIO_Pin_6|GPIO_Pin_11;	//引脚编号
	GPIO_Init(GPIOC, &GPIO_InitStructure);
	
    GPIO_InitStructure.GPIO_Pin 	= GPIO_Pin_6|GPIO_Pin_7;	//引脚编号
    ...
    GPIO_SetBits(GPIOC,GPIO_Pin_6|GPIO_Pin_11); //总线空闲
    GPIO_SetBits(GPIOD,GPIO_Pin_6|GPIO_Pin_7);  //总线空闲
}
